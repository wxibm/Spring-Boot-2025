...
public class NewsController {
    ...
    @PostMapping("/news")
    public ReturnT<News> insertNews(@RequestBody News news,@RequestHeader("token") String token) {
        return newsService.insertNews(news, token);
    }

    @PutMapping("/news")
    public ReturnT<News> updateNews(@RequestBody News news,@RequestHeader("token") String token) {
