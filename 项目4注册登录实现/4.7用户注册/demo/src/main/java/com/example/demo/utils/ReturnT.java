...
public class ReturnT<T> implements Serializable {
    ...
    public static <T> ReturnT<T> USERNAME_EXISTS(){
        return new ReturnT<>(ReturnCode.USERNAME_EXISTS.getCode(), ReturnCode.USERNAME_EXISTS.getMsg());
    }

    public static <T> ReturnT<T> FORMAT_ERROR(String msg){
        return new ReturnT<>(ReturnCode.FORMAT_ERROR.getCode(), msg);
    }
}